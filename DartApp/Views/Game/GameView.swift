            ...
            VStack{
                ...
                HStack{
                    ...
                    .background(currentPlayerIsOne == true ?
                        ...
                        .fill(Color.white)
                        .shadow(radius: 2))
                    .foregroundColor(currentPlayerIsOne == true ? .white : .black)
                    ...
                    .background(currentPlayerIsOne == false ?
                        ...
                        .fill(Color.white)
                        .shadow(radius: 2))
                    .foregroundColor(currentPlayerIsOne == false ? .white : .black)
                        ...
                        ForEach(keyboardButtons, id: \.self) { row in
                            ForEach(row, id: \.self) { number in
                                Button(action: {
                                    ...
                                    .foregroundColor(selectedNumber == number ? Color.white : Color.black)
                                }
                            }
                        }
                    }
